...
public class WpkCommonUtil {
	
	private static final Logger logger = LoggerFactory.getLogger(WpkCommonUtil.class);
	
	
	public static List<Map<String, Object>> convertOrderIdxToColName(List<Map<String, Object>> orderIdxs, List<Map<String, Object>> colNames) {
		
/*		for (Map<String, Object> mapOrderIdx: orderIdxs) {
			
 			Map<String, Object> mapColName = colNames.get(mapOrderIdx.get("column"));
			
			logger.debug("################################################");
			logger.debug("index : " + mapOrderIdx.get("column"));
			
			String colName = (String) mapColName.get("name");
			
			logger.debug("################################################");
			logger.debug("colName : " + colName);
			
			mapOrderIdx.put("colName", colName);
		}
*/		
		return orderIdxs;
	}
