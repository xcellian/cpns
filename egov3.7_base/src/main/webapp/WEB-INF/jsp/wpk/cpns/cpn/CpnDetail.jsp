...
<head>
	...
	<script src="<c:url value='/js/common.js?v=20180601017' />" ></script>
			...
			<div class="main-section k-content pd-3">
				<form id="dtlForm">
					<ul class="fieldlist">
						...
						<li>
							<label for="input-cpnCd" class="required">쿠폰코드</label>
						...
						<li>
							...
							<input id="input-cpnNm" name="쿠폰명" type="text" class="k-textbox op-1 editable" style="width: 100%;" 
